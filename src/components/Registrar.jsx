...
export function Registrar() {
  ...
  function handleSubmit(evt) {
    const url = "http://prueba3-production.up.railway.app/api/users";
    ...
    <>
      ...
      <section className="bg-white rounded-bottom p-3">
        <div className="container px-5">
          <h2 className="text-blue-dark text-center fs-3">
            Registro de usuario
          </h2>
          <form className="px-5" method="POST" onSubmit={handleSubmit}>
            <div className="mb-1">
              <label
                htmlFor="exampleInputCorreoElectronico"
            ...
            <div className="mb-3">
              <label
                htmlFor="exampleInputTipoIndenUsuario"
                className="form-label"
              >
              ...
              <select
                id="ctl00_ContentPlaceHolder1_dpexampleInputValidator1"
            ...
            <div className="mb-1">
              <label
                htmlFor="exampleInputNunIdenUsuario"
                className="form-label"
              >
                Número Identificación del usuario:
                <span className="color-span">*</span>
              </label>
              <input
                type="number"
                className="form-control"
                id="exampleInputValidator2"
              ...
              <small>
                <span className="text-secondary">
                  Sin puntos ni carácteres especiales
                </span>
              </small>
            </div>
            <div className="mb-1">
            ...
            <div className="mb-1">
              <label htmlFor="exampleConfirCorreoElect" className="form-label">
              ...
              <input
                type="email"
                className="form-control"
                id="exampleInputValidator4"
                name="emailConfirmation"
                value={userInfo.emailConfirmation}
                onChange={handleChange}
                onBlur={handleEmailConfirmation}
                required
              />
            </div>
            <div className="mb-1">
              ...
              <span
                title="La clave debe tener mínimo 8 caracteres y contener al menos una letra mayúscula y un número"
            ...
            <div className="mb-3">
              <div className="form-group has-error">
                <label
                  htmlFor="exampleConfirCorreoElect"
                  className="form-label"
                >
                  Confirmación clave:
                  <span className="color-span">*</span>
