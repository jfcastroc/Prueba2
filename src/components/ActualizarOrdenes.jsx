...
export function ActualizarOrdenes() {
  ...
  useEffect(() => {
    const url = "http://prueba3-production.up.railway.app/api/orders/id";
    const headers = {
  ...
  function handleSubmit(evt) {
    const url =
      "http://prueba3-production.up.railway.app:9000/api/orders/update";
          ...
          <form className="px-5" method="POST" onSubmit={handleSubmit}>
              ...
              <div className="row">
                <div className="col">
                  ...
                  <input
                    ...
                    id="fecha"
                    name="fecha"
                    value={datosOrden.fecha.split("T")[0] || ""}
            ...
            <div className="mb-3">
              ...
              <input
                ...
                value={datosOrden.direccionRecogida || ""}
                onChange={handleChange}
              />
            </div>
            <div className="mb-3">
              ...
              <input
                ...
                id="ciudadrecogida"
                name="ciudadRecogida"
                value={datosOrden.ciudadRecogida || ""}
                onChange={handleChange}
              />
            </div>
            <div className="mb-3">
              <label htmlFor="nombresdestinatario" className="form-label">
                Nombre destinatario
              </label>
              <input
                type="text"
                className="form-control"
                id="nombresdestinatario"
                name="nombreDestinatario"
                value={datosOrden.nombreDestinatario || ""}
                onChange={handleChange}
              />
            </div>
            <div className="mb-3">
              <label htmlFor="nitdestinatario" className="form-label">
              ...
              <input
                ...
                value={datosOrden.numIdentificacionDestinatario || ""}
                onChange={handleChange}
              />
            </div>
            <div className="mb-3">
              ...
              <input
                ...
                value={datosOrden.direccionEntrega || ""}
                onChange={handleChange}
              />
            </div>
            <div className="mb-3">
              <label htmlFor="ciudadentrega" className="form-label">
                Ciudad entrega
              </label>
              <input
                type="text"
                ...
                id="ciudadentrega"
                name="ciudadEntrega"
                value={datosOrden.ciudadEntrega || ""}
                onChange={handleChange}
              />
            </div>
