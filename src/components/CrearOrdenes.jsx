        ...
        <div className="container-fluid">
          ...
          <form className="px-5" method="POST" onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              <div className="row">
                <div className="col">
                  <label for="ancho" className="form-label">
                    Ancho
                  </label>
                  <input
                    type="text"
                    ...
                    id="ancho"
                    name="ancho"
                    value={orderInfo.ancho}
                    onChange={handleChange}
                    required
                  />
                </div>
                <div className="col">
                  <label for="largo" className="form-label">
                    Largo
                  </label>
                  <input
                    type="text"
                    ...
                    id="largo"
                    name="largo"
                    value={orderInfo.largo}
                    onChange={handleChange}
                    required
                  />
                </div>
                <div className="col">
                  <label for="alto" className="form-label">
                    Alto
                  </label>
                  <input
                    type="text"
            ...
            <div className="mb-3">
              <label for="direccionrecogida" className="form-label">
                Direccion recogida
              </label>
              <input
                type="text"
                ...
                value={orderInfo.direccionRecogida}
                onChange={handleChange}
                required
              />
            </div>
            <div className="mb-3">
              <label for="ciudadrecogida" className="form-label">
                Ciudad recogida
              </label>
              <input
                type="text"
                ...
                id="ciudadRecogida"
                name="ciudadRecogida"
                value={orderInfo.ciudadRecogida}
                onChange={handleChange}
                required
              />
            </div>
            <div className="mb-3">
              <label for="nombresdestinatario" className="form-label">
                Nombre destinatario
              </label>
              <input
                type="text"
                ...
                value={orderInfo.nombreDestinatario}
                onChange={handleChange}
                required
              />
            </div>
            <div className="mb-3">
              <label for="nitdestinatario" className="form-label">
                Cedula/NIT destinatario
              </label>
              <input
                type="text"
                className="form-control"
                id="numIdentificacionDestinatario"
                name="numIdentificacionDestinatario"
                value={orderInfo.numIdentificacionDestinatario}
                onChange={handleChange}
                required
              />
            </div>
            <div className="mb-3">
              <label for="direccionentrega" className="form-label">
                Direccion entrega
              </label>
              <input
                type="text"
                ...
                value={orderInfo.direccionEntrega}
                onChange={handleChange}
                required
              />
            </div>
            <div className="mb-3">
              <label for="ciudadentrega" className="form-label">
                Ciudad entrega
              </label>
              <input
                type="text"
